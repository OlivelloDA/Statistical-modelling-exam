...
fitsp3 = spm(priceHouse~ f(meanIncome) + healthSocial + healthSocial^2, spar.method = "ML")
fitsp4 = spm(priceHouse~ meanIncome+f(healthSocial) +meanIncome^2,spar.method = "ML") #sum of two univariate function, not a bivariate function
